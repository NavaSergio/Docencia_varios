...
- Los datos pueden contener errores, valores atípicos (outliers) y problemas estructurales.
...
## **Parte 4: Impacto de los Outliers en el Análisis de Datos** {.scrollable}

Los valores atípicos pueden:

- **Sesgar la media** y otras métricas estadísticas.
- **Afectar la precisión de modelos predictivos**, especialmente en regresión.
- **Influir en los supuestos de normalidad y homogeneidad de varianza**.

### **Ejemplo: Outliers en Datos Financieros**
- En publicidad digital (PPC - Pay Per Click), un gap inusual en los valores puede indicar errores en la recopilación de datos.
- En precios de productos, valores atípicos pueden representar errores de captura o productos fuera del rango esperado.

---

## **Parte 5: Estrategias para Manejar Outliers** {.scrollable}
...
- Validar los supuestos estadísticos es clave para evitar errores en el análisis de datos.
